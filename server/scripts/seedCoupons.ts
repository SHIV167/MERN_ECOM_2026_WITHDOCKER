...
async function seedCoupons() {
  try {
    // Connect to MongoDB
    await mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/ecommercepro');
    ...
    console.log('To test the frontend validation, use coupon WELCOME25 with a cart value of at least ₹1000.');
